                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="menu">
                          <li><!-- start message -->
                            <a href="#">
                              <div class="pull-left">
                                <!-- User Image -->
                                <img src="{!!asset('img/backend/placeholder-user.jpg')!!}" class="img-circle" alt="User Image"/>
                              </div>
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <img src="{!!asset('img/backend/placeholder-user.jpg')!!}" class="user-image" alt="User Image"/>

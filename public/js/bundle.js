...
new Vue({
  ...
  data: {
    ...
    questions: [{
      ...
      'correct_answer': 'x',
      'created_at': '1980-03-28 23:57:39',
      'updated_at': '1985-05-19 11:18:09',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '35 år sedan',
      'user': {
        'id': 2,
      ...
      'correct_answer': '1',
      'created_at': '1998-01-01 19:58:00',
      'updated_at': '2001-12-15 21:23:59',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '17 år sedan',
      'user': {
        'id': 2,
        'name': 'Anders Svensson',
        'email': 'user@user.com',
      ...
      'correct_answer': 'x',
      'created_at': '1974-08-15 17:45:32',
      'updated_at': '1970-09-09 00:26:10',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '40 år sedan',
      'user': {
        'id': 2,
        'name': 'Anders Svensson',
        'email': 'user@user.com',
      ...
      'correct_answer': '1',
      'created_at': '1991-03-07 20:50:26',
      'updated_at': '1976-12-24 18:10:35',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '24 år sedan',
      'user': {
        'id': 2,
        'name': 'Anders Svensson',
        'email': 'user@user.com',
      ...
      'correct_answer': '2',
      'created_at': '1992-09-21 12:34:30',
      'updated_at': '1977-08-13 10:01:59',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '22 år sedan',
      'user': {
        'id': 2,
        'name': 'Anders Svensson',
        'email': 'user@user.com',
      ...
      'correct_answer': 'x',
      'created_at': '1981-01-17 10:50:13',
      'updated_at': '1974-01-20 09:56:42',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '34 år sedan',
      'user': {
        'id': 4,
      ...
      'correct_answer': '1',
      'created_at': '1993-10-13 11:49:23',
      'updated_at': '1999-10-09 03:38:46',
      'tipspromenaderCount': 1,
      'created_at_diffForHumans': '21 år sedan',
      'user': {
        'id': 2,
        'name': 'Anders Svensson',
        'email': 'user@user.com',
...
},{"jquery":2,"vue":76,"vue-resource":5}],2:[function(require,module,exports){
/*!
...
},{"./lib/jsonp":6,"./lib/util":8,"./lib/xhr":9}],5:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":4,"./resource":10,"./url":11}],6:[function(require,module,exports){
/**
 * JSONP request.
 */
...
},{"./promise":7,"./util":8}],7:[function(require,module,exports){
/**
...
},{"./promise":7,"./util":8}],10:[function(require,module,exports){
/**
...
},{"./lib/util":8}],11:[function(require,module,exports){
/**
...
},{"./lib/util":8}],12:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler":22,"../util":73,"_process":3}],18:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":24,"./util":73,"_process":3}],19:[function(require,module,exports){
/**
...
},{"../config":24,"../directives/prop":40,"../parsers/path":63,"../parsers/text":65,"../util":73,"_process":3}],21:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../config":24,"../directives/component":29,"../parsers/directive":61,"../parsers/template":64,"../parsers/text":65,"../util":73,"./compile-props":20,"_process":3}],22:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":24,"../parsers/template":64,"../util":73,"_process":3}],24:[function(require,module,exports){
module.exports = {
...
},{"../parsers/template":64,"../util":73,"_process":3}],30:[function(require,module,exports){
module.exports = {
...
},{"../compiler":22,"../parsers/template":64,"../transition":66,"../util":73,"_process":3}],33:[function(require,module,exports){
...
},{"../../util":73,"./checkbox":34,"./radio":36,"./select":37,"./text":38,"_process":3}],36:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":61,"../../util":73,"../../watcher":77,"_process":3}],38:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":73,"_process":3}],40:[function(require,module,exports){
...
},{"../util":73,"_process":3}],42:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../compiler":22,"../parsers/expression":62,"../parsers/template":64,"../parsers/text":65,"../util":73,"_process":3}],43:[function(require,module,exports){
var transition = require('../transition')
...
},{"../cache":19,"../compiler":22,"../directives/if":32,"../parsers/template":64,"../parsers/text":65,"../util":73,"_process":3}],50:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../util":73,"_process":3}],54:[function(require,module,exports){
...
},{"../util":73,"_process":3}],56:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":22,"../observer":59,"../observer/dep":58,"../util":73,"../watcher":77,"_process":3}],57:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":19,"../util":73,"./path":63,"_process":3}],63:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":19,"../util":73,"_process":3}],64:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./index":73,"_process":3}],70:[function(require,module,exports){
(function (process){
/**
...
},{"../config":24,"_process":3}],71:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
...
},{"../config":24,"./index":73,"_process":3}],72:[function(require,module,exports){
...
},{"../config":24,"./index":73,"_process":3}],76:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./batcher":18,"./config":24,"./observer/dep":58,"./parsers/expression":62,"./util":73,"_process":3}]},{},[1]);
